...
import translations from './exercises_007.json'
import type { ExerciseTranslations } from '../types'

const batch = exercises.slice(600, 700)
const typed: ExerciseTranslations = translations

describe('exercises_007.json — Spanish translations for exercises 0601–0700', () => {
