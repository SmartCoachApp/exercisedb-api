...
import translations from './exercises_013.json'
import type { ExerciseTranslations } from '../types'

const batch = exercises.slice(1200, 1300)
const typed: ExerciseTranslations = translations

describe('exercises_013.json — Spanish translations for exercises 1200-1299', () => {
