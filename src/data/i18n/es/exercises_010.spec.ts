...
import translations from './exercises_010.json'
import type { ExerciseTranslations } from '../types'

const batch = exercises.slice(900, 1000)
const typed: ExerciseTranslations = translations

describe('exercises_010.json — Spanish translations for exercises 0901–1000', () => {
