...
import translations from './exercises_004.json'
import type { ExerciseTranslations } from '../types'

const batch = exercises.slice(300, 400)
const typed: ExerciseTranslations = translations

describe('exercises_004.json — Spanish translations for exercises 300-399', () => {
  ...
  it('names are in Spanish (not identical to English)', () => {
    ...
    // At least 95% should be different (some proper nouns might stay the same)
