...
import translations from './exercises_006.json'
import type { ExerciseTranslations } from '../types'

const batch = exercises.slice(500, 600)
const typed: ExerciseTranslations = translations

describe('exercises_006.json — Spanish translations for exercises 0501–0600', () => {
