...
import translations from './exercises_011.json'
import type { ExerciseTranslations } from '../types'

const batch = exercises.slice(1000, 1100)
const typed: ExerciseTranslations = translations

describe('exercises_011.json — Spanish translations for exercises 1000-1099', () => {
