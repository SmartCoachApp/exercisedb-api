...
import translations from './exercises_002.json'
import type { ExerciseTranslations } from '../types'

const batch = exercises.slice(100, 200)
const typed: ExerciseTranslations = translations

describe('exercises_002.json — Spanish translations for exercises 0101–0200', () => {
