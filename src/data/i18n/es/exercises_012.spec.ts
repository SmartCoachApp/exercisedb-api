...
import translations from './exercises_012.json'
import type { ExerciseTranslations } from '../types'

const batch = exercises.slice(1100, 1200)
const typed: ExerciseTranslations = translations

describe('exercises_012.json — Spanish translations for exercises 1100-1199', () => {
